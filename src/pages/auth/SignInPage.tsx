          ...
          <div className="mx-auto rounded-lg bg-white p-6 shadow dark:bg-gray-800 sm:max-w-xl sm:p-8">
            ...
            <form className="mt-4 space-y-6 sm:mt-6" action="#">
              ...
              <div className="space-y-3">
                <Button href="#" color="gray" className="w-full hover:bg-gray-50 dark:hover:bg-gray-700">
                  <svg
                    aria-hidden
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    <Label htmlFor="remember-illustration" className="text-gray-500 dark:text-gray-300">Remember me</Label>
                  </div>
                </div>
                <a
                  href="#"
